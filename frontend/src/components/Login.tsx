        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg text-sm mb-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium">Demo Mode - Backend Not Deployed</p>
                <p className="text-xs mt-1">The frontend is deployed successfully, but the backend API is not yet deployed. Login functionality requires a backend server.</p>
              </div>
            </div>
          </div>
