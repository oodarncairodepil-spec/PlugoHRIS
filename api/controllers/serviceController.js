...
exports.deleteService = exports.toggleServiceStatus = exports.updateService = exports.createService = exports.getServiceById = exports.getActiveServices = exports.getAllServices = void 0;
...
const toggleServiceStatus = async (req, res) => {
    try {
        ...
        const { data: currentService, error: fetchError } = await supabase_1.supabase
            .from('services')
            .select('is_active')
            .eq('id', id)
            .single();
